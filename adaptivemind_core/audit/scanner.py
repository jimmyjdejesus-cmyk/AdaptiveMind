...
from .models import AuditCategory, AuditFinding, ScanConfiguration, SeverityLevel
...
class SecurityScanner(BaseScanner):
    ...
    def _convert_bandit_finding(self, issue: dict[str, Any]) -> AuditFinding | None:
...
class DependencyScanner(BaseScanner):
    ...
    def _convert_safety_finding(self, vuln: dict[str, Any]) -> AuditFinding | None:
