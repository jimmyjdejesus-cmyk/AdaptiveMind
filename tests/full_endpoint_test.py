...
class FullEndpointTester:
    ...
    def test_endpoint(self, method: str, endpoint: str, data: dict | None = None, description: str = "", headers: dict | None = None) -> dict[str, Any]:
    ...
    def generate_full_report(self) -> str:
        ...
        report += "**OpenAPI Specification**: Complete endpoint coverage\n\n"
