...
class IntegrationContractTester:
    ...
    async def validate_database_state_after_chat(self, chat_request: dict[str, Any], expected_changes: list[str] | None = None):
...
async def run_integration_tests():
    ...
    try:
        ...
        await suite.test_complete_integration_suite(tester)
